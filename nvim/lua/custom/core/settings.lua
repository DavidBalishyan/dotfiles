...
vim.keymap.set('n', '<leader>th', ':colo gruvbox<CR>', { noremap = true, desc = ':colo gruvbox' })
vim.keymap.set('n', '<leader>tt', ':colo tokyonight-night<CR>', { noremap = true, desc = ':colo tokyonight-night' })
vim.keymap.set('n', '<leader>tn', ':colo carbonfox<CR>', { noremap = true, desc = ':colo carbonfox' })
