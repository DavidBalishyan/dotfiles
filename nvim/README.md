...
>[!NOTE]
>I don't actively update this list, so it might be outdated
...
| [lualine](https://github.com/dimitry-ishenko-neovim/lualine-nvim)                                | Add a beautiful looking command bar  |
| [render-markdown.nvim](https://github.com/MeanderingProgrammer/render-markdown.nvim)             | Rendering markdown                   | 
