...
link_if_installed tmux "$repo_root/tmux/plugins/tokyonight" "$HOME/.config/tmux/plugins/tokyonight" "tmux Tokyo Night theme"
...
link_if_installed cboomer "$repo_root/config.boom" "$HOME/.config/cboomer/config" "cboomer"
link_if_installed kitty "$repo_root/kitty.conf" "$HOME/.config/kitty/kitty.conf" "kitty"
